...
class Bantuan extends RestController {
    ...
    public function index_put()
    {
        ...
        if($data_nomor !== null){
            $data = $data_nomor;
            $update =  $this->db->update_batch('bantuan', $data, 'id');}
        else{
                $data = array(
    ...
    public function index_get()
    {
        ...
        $jsonData = $this->db->get('bantuan')->result();
        if ( $id === null )
        {
            ...
            if ( $jsonData)
            {
                ...
                $this->db->join('users','users.id = bantuan.id_user');
                $this->db->join('users_details','users_details.id_user = bantuan.id_user');
